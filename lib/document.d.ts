export default interface CollaboraDocument {
   ...
   * @param options - A comma-separated string of filter options forwarded to Collabora. See the Collabora documentation for the filters available for a given format.
